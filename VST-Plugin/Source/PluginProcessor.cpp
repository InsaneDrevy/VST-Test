...
//==============================================================================
const juce::String VSTPluginAudioProcessor::getName() const
{
...
const juce::String VSTPluginAudioProcessor::getProgramName (int index)
{
    return {};
}

void VSTPluginAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void VSTPluginAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
